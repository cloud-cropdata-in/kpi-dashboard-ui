...
declare var $;
@Component({
  selector: 'app-actual-crop-area',
  templateUrl: './actual-crop-area.component.html',
  styleUrls: ['./actual-crop-area.component.scss'],
})
export class ActualCropAreaComponent implements OnInit {
  regionalDetails: any;
  ...
  constructor(private getActualCropAreaDetail: DashboardService) {
    this.getAnalyticsDetails();
  }
  getAnalyticsDetails() {
    this.getActualCropAreaDetail.getActualCropAreaDetails().subscribe(
      (data) => {
