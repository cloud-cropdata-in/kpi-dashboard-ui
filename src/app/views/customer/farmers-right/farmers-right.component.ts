...
declare var $;
@Component({
  selector: 'app-farmers-right',
  templateUrl: './farmers-right.component.html',
  styleUrls: ['./farmers-right.component.scss'],
})
export class FarmersRightComponent implements OnInit {
  analyticsDetails: any;
  isRightsOnboardedDetailShown: boolean = false;
  isActualCroppAreaDetailShown: boolean = false;
  isActualProductionDetailShown: boolean = false;
  isActualValueDetailShown: boolean = false;
  ...
  getAnalyticsDetails() {
    this.dashboardService.getAnalyticsDetails().subscribe((data) => {
      ...
      this.analyticsDetails = data.target_meter_gauge.rights;
      this.afterLoad();
    });
  }

  // toggleShowActualLeadsDetail() {
  //   this.isActualLeadsDetailShown = !this.isActualLeadsDetailShown;
  //   this.isRightsOnboardedDetailShown = false;
  //   this.isActualCroppAreaDetailShown = false;
  //   this.isActualProductionDetailShown = false;
  //   this.isActualValueDetailShown = false;
  //   $('#isActualLeadsDetailShown').slideToggle('fast');
  //   $('#isRightsOnboardedDetailShown').hide();
  //   $('#isActualCroppAreaDetailShown').hide();
  //   $('#isActualProductionDetailShown').hide();
  //   $('#isActualValueDetailShown').hide();
  // }

  toggleShowRightsOnboardedDetail() {
    this.isRightsOnboardedDetailShown = !this.isRightsOnboardedDetailShown;
    this.isActualCroppAreaDetailShown = false;
    this.isActualProductionDetailShown = false;
    this.isActualValueDetailShown = false;
    $('#isRightsOnboardedDetailShown').slideToggle('fast');
    $('#isActualCroppAreaDetailShown').hide();
    $('#isActualProductionDetailShown').hide();
    $('#isActualValueDetailShown').hide();
  }

  toggleShowActualCroppAreaDetail() {
    this.isRightsOnboardedDetailShown = false;
    this.isActualCroppAreaDetailShown = !this.isActualCroppAreaDetailShown;
    this.isActualProductionDetailShown = false;
    this.isActualValueDetailShown = false;
    $('#isRightsOnboardedDetailShown').hide();
    $('#isActualCroppAreaDetailShown').slideToggle('fast');
    $('#isActualProductionDetailShown').hide();
    $('#isActualValueDetailShown').hide();
  }

  toggleShowActualProductionDetail() {
    this.isRightsOnboardedDetailShown = false;
    this.isActualCroppAreaDetailShown = false;
    this.isActualProductionDetailShown = !this.isActualProductionDetailShown;
    this.isActualValueDetailShown = false;
    $('#isRightsOnboardedDetailShown').hide();
    $('#isActualCroppAreaDetailShown').hide();
    $('#isActualProductionDetailShown').slideToggle('fast');
    $('#isActualValueDetailShown').hide();
  }

  toggleShowActualValuesDetail() {
    this.isRightsOnboardedDetailShown = false;
    this.isActualCroppAreaDetailShown = false;
    this.isActualProductionDetailShown = false;
    this.isActualValueDetailShown = !this.isActualValueDetailShown;
    $('#isRightsOnboardedDetailShown').hide();
    $('#isActualCroppAreaDetailShown').hide();
    $('#isActualProductionDetailShown').hide();
    $('#isActualValueDetailShown').slideToggle('fast');
  }
