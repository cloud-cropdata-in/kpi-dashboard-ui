...
declare var $;
@Component({
  selector: 'app-crop-area-2',
  templateUrl: './crop-area.component.html',
  styleUrls: ['./crop-area.component.scss'],
})
export class CropAreaComponent2 implements OnInit {
  regionalDetails: any;
  ...
  constructor(private getCropAreaDetail: DashboardService) {
    this.getAnalyticsDetails();
  }
  getAnalyticsDetails() {
    this.getCropAreaDetail.getCropAreaDetails().subscribe((data) => {
