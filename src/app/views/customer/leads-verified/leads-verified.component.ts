...
@Component({
  selector: 'app-leads-verified',
  templateUrl: './leads-verified.component.html',
  styleUrls: ['./leads-verified.component.scss'],
})
export class LeadVerifiedLeadsComponent implements OnInit {
