...
declare var $;
@Component({
  selector: 'app-verified-leads',
  templateUrl: './verified-leads.component.html',
  styleUrls: ['./verified-leads.component.scss'],
})
export class VerifiedLeadsComponent implements OnInit {
  regionalDetails: any;
  ...
  constructor(private getVerifiedLeadsDetail: DashboardService) {
    this.getAnalyticsDetails();
  }
  getAnalyticsDetails() {
    this.getVerifiedLeadsDetail.getVerifiedLeadsDetails().subscribe((data) => {
