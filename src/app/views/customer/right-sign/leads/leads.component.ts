...
declare var $;
@Component({
  selector: 'app-leads-4',
  templateUrl: './leads.component.html',
  styleUrls: ['./leads.component.scss'],
})
export class LeadsComponent4 implements OnInit {
  regionalDetails: any;
  ...
  constructor(private getLeadsDetail: DashboardService) {
    this.getAnalyticsDetails();
  }
  getAnalyticsDetails() {
    this.getLeadsDetail.getLeadsDetails().subscribe((data) => {
