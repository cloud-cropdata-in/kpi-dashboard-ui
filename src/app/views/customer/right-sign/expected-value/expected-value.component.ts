...
declare var $;
@Component({
  selector: 'app-expected-value-4',
  templateUrl: './expected-value.component.html',
  styleUrls: ['./expected-value.component.scss'],
})
export class ExpectedValueComponent4 implements OnInit {
  regionalDetails: any;
  ...
  constructor(private getExpecteValueDetail: DashboardService) {
    this.getAnalyticsDetails();
  }
  getAnalyticsDetails() {
    this.getExpecteValueDetail.getExpecteValueDetails().subscribe((data) => {
